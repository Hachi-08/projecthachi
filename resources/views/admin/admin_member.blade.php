                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">หน้ากรอกข้อมูลสมาชิก</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="row g-3" action="{{ route('add_admin_member') }}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="inputName5" class="form-label">นามสกุล</label>
                                                        <input type="text" class="form-control" id="inputName5"
                                                            name="surname"required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="inputEmail5" class="form-label">ชื่อ
                                                            เข้าสู่ระบบ</label>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-sortable="" style="width: 18.9621%;"><a
                                                        href="#" class="dataTable-sorter">ชื่อ</a></th>
                                                <th scope="col" data-sortable="" style="width: 18.9621%;"><a
                                                        href="#" class="dataTable-sorter">นามสกุล</a></th>
                                                <th scope="col" data-sortable="" style="width: 9.1151%;"><a
                                                        href="#" class="dataTable-sorter">เลขที่บ้าน</a></th>
                                                <th scope="col" data-sortable="" style="width: 18.9621%;"><a
                                                        href="#" class="dataTable-sorter">เบอร์โทรติดต่อ</a>
                                                </th>
                                                <th scope="col" data-sortable="" style="width: 18.9621%;"><a
                                                        href="#" class="dataTable-sorter">สถานะ</a>
                                                </th>
                                                <th scope="col" data-sortable="" style="width: 9.1151%;"><a
