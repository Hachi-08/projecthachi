...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ route('offieer_profile') }}">
                    <i class="bi bi-person"></i>
                    <span>Profile</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('offieer_record') }}">
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Profile   ---offieer   {{ session()->get('name') }} {{ session()->get('surname') }} {{ session()->get('level_name') }}</h1>
                <nav>
                    <ol class="breadcrumb">
                            ...
                            <div class="card-body pt-3">
                                <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                                    <li class="nav-item" role="presentation"> <button class="nav-link active"
                                            ...
                                            aria-selected="true" role="tab">Overview</button></li>
                                    ...
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit" role="tabpanel">
                                        <form>
                                            ...
                                            <div class="row mb-3"> <label for="Instagram"
                                                ...
                                                <div class="col-md-8 col-lg-9"> <input name="instagram"
                                            ...
                                            <div class="row mb-3"> <label for="fullName"
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <div class="form-check"> <input class="form-check-input"
                                                            type="checkbox" id="changesMade" checked=""> <label
                                                            class="form-check-label" for="changesMade"> Changes made
                                                            to your account </label></div>
                                                    <div class="form-check"> <input class="form-check-input"
                                                            type="checkbox" id="newProducts" checked=""> <label
                                                            class="form-check-label" for="newProducts"> Information on
                                                            new products and services </label></div>
                                                    <div class="form-check"> <input class="form-check-input"
                                                            type="checkbox" id="proOffers"> <label
                                                            class="form-check-label" for="proOffers"> Marketing and
                                                            promo offers </label></div>
                                                    <div class="form-check"> <input class="form-check-input"
                                                            type="checkbox" id="securityNotify" checked=""
